...
import com.orgacare.app.service.GroupeService;
...
/**
 * REST controller for managing {@link com.orgacare.app.domain.Groupe}.
 */
@RestController
@RequestMapping("/api")
public class GroupeResource {
    ...
    private static final String ENTITY_NAME = "orgaCareGroupe";
     ...
     */
    @GetMapping("/groupes")
    public ResponseEntity<List<GroupeDTO>> getAllGroupes(Pageable pageable) {
