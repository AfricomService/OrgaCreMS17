...
import com.orgacare.app.service.GradeService;
...
/**
 * REST controller for managing {@link com.orgacare.app.domain.Grade}.
 */
@RestController
@RequestMapping("/api")
public class GradeResource {
    ...
    private static final String ENTITY_NAME = "orgaCareGrade";
     ...
     */
    @GetMapping("/grades")
    public ResponseEntity<List<GradeDTO>> getAllGrades(Pageable pageable) {
